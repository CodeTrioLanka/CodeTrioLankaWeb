            ...
            <div className="p-8 rounded-2xl bg-card border border-border">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-secondary/10 dark:bg-primary/10 rounded-xl flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-secondary/10 dark:bg-primary/10 rounded-xl flex items-center justify-center flex-shrink-0">
                    <svg viewBox="0 0 24 24" className="w-6 h-6 fill-secondary dark:fill-primary" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-secondary/10 dark:bg-primary/10 rounded-xl flex items-center justify-center flex-shrink-0">
                    <Facebook className="w-5 h-5 text-secondary dark:text-primary" />
                  </div>
                  <div>
